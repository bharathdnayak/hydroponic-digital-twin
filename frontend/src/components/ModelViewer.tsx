...
export default function ModelViewer({ url = '/test.glb' }: ModelViewerProps) {
  ...
  return (
    <div 
      className={
        isFullscreen 
          ? 'fixed inset-0 z-50 bg-[#e2e8f0] p-6 flex flex-col animate-in fade-in duration-200' 
          : 'w-full h-full relative bg-[#e2e8f0] rounded-[24px] overflow-hidden border border-slate-200/80 shadow-sm'
      }
    >
