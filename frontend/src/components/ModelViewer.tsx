...
export default function ModelViewer({ url = '/test.glb' }: ModelViewerProps) {
  ...
  return (
    <div 
      className={
        isFullscreen 
          ? 'fixed inset-0 z-50 bg-[#606060] p-6 flex flex-col animate-in fade-in duration-200' 
          : 'w-full h-full relative bg-[#606060] rounded-[24px] overflow-hidden border border-slate-700/80 shadow-sm'
      }
    >
      ...
      <div className="absolute top-4 left-6 z-10 pointer-events-none select-none">
        ...
        <p className="text-xs text-slate-300 mt-0.5">Use mouse to rotate, pan, and zoom</p>
      </div>
      ...
      <div className="absolute top-4 right-6 z-20 flex gap-2">
        <button
          ...
          className={`flex items-center justify-center gap-1.5 px-4 py-2.5 rounded-xl border shadow-sm backdrop-blur-md transition-all duration-200 cursor-pointer font-bold text-xs ${
            isFlowing
        ...
        <button
          ...
          className="flex items-center justify-center p-2.5 rounded-xl border border-white/20 bg-white/15 hover:bg-white/25 text-white shadow-sm backdrop-blur-md transition-all duration-200 cursor-pointer"
